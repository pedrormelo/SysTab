...
--
-- Host: 127.0.0.1
-- Tempo de geração: 05/05/2025 às 19:50
...
CREATE TABLE `chamados` (
  ...
  `idTab` int(11) NOT NULL, -- Alterado de idTomb para idTab
...
INSERT INTO `tablets` (`idTomb`, `imei`, `idUser`, `idEmp`, `idUnidade`, `idTab`) VALUES
(208474, '355637052256005', 4, 3, 4, 1);
...
ALTER TABLE `chamados`
  ...
  ADD KEY `idTab` (`idTab`); -- Alterado de idTomb para idTab
...
--
ALTER TABLE `chamados`
  ADD CONSTRAINT `chamados_ibfk_1` FOREIGN KEY (`idTab`) REFERENCES `tablets` (`idTab`); -- Alterado de idTomb para idTab
